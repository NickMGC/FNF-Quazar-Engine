...
class MusicState extends FlxState {
	...
	@:keep inline public function addStepSignal(callback:Void -> Void):Void conductor.step.signal.add(callback);
	@:keep inline public function addBeatSignal(callback:Void -> Void):Void conductor.beat.signal.add(callback);
	@:keep inline public function addMeasureSignal(callback:Void -> Void):Void conductor.measure.signal.add(callback);

	@:keep inline public function removeStepSignal(callback:Void -> Void):Void conductor.step.signal.remove(callback);
	@:keep inline public function removeBeatSignal(callback:Void -> Void):Void conductor.beat.signal.remove(callback);
	@:keep inline public function removeMeasureSignal(callback:Void -> Void):Void conductor.measure.signal.remove(callback);
