 ...
 * ## Basic Usage
 * ```haxe
 * var tailSprite:FlxTailedSprite = new FlxTailedSprite(100, 100).loadGraphic("assets/spritesheet.png", true, 32, 32);
 * tailSprite.animation.add("body", [0, 1, 2], 10);
 * tailSprite.animation.add("tail", [3, 4, 5], 10);
